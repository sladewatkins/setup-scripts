...
brew update && brew install altserver 1password 1password-cli spotify discord steam steamcmd iina git imageoptim microsoft-office android-platform-tools rbenv mas discord
